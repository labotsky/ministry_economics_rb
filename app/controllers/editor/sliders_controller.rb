class Editor::SlidersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @slider.save
        format.html { redirect_to editor_sliders_url, notice: 'Изображение успешно добавлено к слайдеру.' }
  ...
  def update
    respond_to do |format|
      if @slider.update(slider_params)
        format.html { redirect_to editor_sliders_url, notice: 'Изображение успешно обнавлено.' }
  ...
  def destroy
    @slider.destroy
    respond_to do |format|
      format.html { redirect_to editor_sliders_url, notice: 'Изображение успешно удалено.' }
